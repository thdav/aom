...
static const aom_cdf_prob default_zeromv_cdf[ZEROMV_MODE_CONTEXTS][CDF_SIZE(2)] = {
  { AOM_ICDF(128*192), AOM_ICDF(32768), 0},
...
#else
static const aom_cdf_prob default_comp_ref_cdf[REF_CONTEXTS][COMP_REFS - 1][CDF_SIZE(2)] = {
