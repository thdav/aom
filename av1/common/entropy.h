...
#if CONFIG_EC_ADAPT
void av1_average_tile_coef_cdfs(struct frame_contexts *fc, struct frame_contexts *ec_ctxs[4]);
void av1_average_tile_mv_cdfs(struct frame_contexts *fc, struct frame_contexts *ec_ctxs[4]);
void av1_average_tile_intra_cdfs(struct frame_contexts *fc, struct frame_contexts *ec_ctxs[4]);
void av1_average_tile_inter_cdfs(struct AV1Common *cm, struct frame_contexts *fc, struct frame_contexts *ec_ctxs[4]);
#endif
#ifdef __cplusplus
}  // extern "C"
#endif
