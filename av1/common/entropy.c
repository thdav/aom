...
static const blockz_cdf_model default_block_zero_cdf_4x4[PLANE_TYPES] = { 
  { // Y plane
    { // Intra
{AOM_ICDF(25024), AOM_ICDF(32768), 0 },
{AOM_ICDF(10816), AOM_ICDF(32768), 0 },
{AOM_ICDF(1088), AOM_ICDF(32768), 0 }
      },
    { // Intra
{AOM_ICDF(24512), AOM_ICDF(32768), 0 },
{AOM_ICDF(15936), AOM_ICDF(32768), 0 },
{AOM_ICDF(3264), AOM_ICDF(32768), 0 }
      }
    },
  { // UV plane
    { // Inter
{AOM_ICDF(27456), AOM_ICDF(32768), 0 },
{AOM_ICDF(16960), AOM_ICDF(32768), 0 },
{AOM_ICDF(5440), AOM_ICDF(32768), 0 }
      },
    { // Inter
{AOM_ICDF(29376), AOM_ICDF(32768), 0 },
{AOM_ICDF(18368), AOM_ICDF(32768), 0 },
{AOM_ICDF(5952), AOM_ICDF(32768), 0 }
      }
    }
  };
static const blockz_cdf_model default_block_zero_cdf_8x8[PLANE_TYPES] = { 
  { // Y plane
    { // Intra
{AOM_ICDF(16064), AOM_ICDF(32768), 0 },
{AOM_ICDF(6720), AOM_ICDF(32768), 0 },
{AOM_ICDF(832), AOM_ICDF(32768), 0 }
      },
    { // Intra
{AOM_ICDF(25920), AOM_ICDF(32768), 0 },
{AOM_ICDF(13888), AOM_ICDF(32768), 0 },
{AOM_ICDF(2368), AOM_ICDF(32768), 0 }
      }
    },
  { // UV plane
    { // Inter
{AOM_ICDF(27200), AOM_ICDF(32768), 0 },
{AOM_ICDF(14528), AOM_ICDF(32768), 0 },
{AOM_ICDF(3776), AOM_ICDF(32768), 0 }
      },
    { // Inter
{AOM_ICDF(28864), AOM_ICDF(32768), 0 },
{AOM_ICDF(18496), AOM_ICDF(32768), 0 },
{AOM_ICDF(5440), AOM_ICDF(32768), 0 }
      }
    }
  };
static const blockz_cdf_model default_block_zero_cdf_16x16[PLANE_TYPES] = { 
  { // Y plane
    { // Intra
{AOM_ICDF(960), AOM_ICDF(32768), 0 },
{AOM_ICDF(704), AOM_ICDF(32768), 0 },
{AOM_ICDF(192), AOM_ICDF(32768), 0 }
      },
    { // Intra
{AOM_ICDF(2496), AOM_ICDF(32768), 0 },
{AOM_ICDF(2496), AOM_ICDF(32768), 0 },
{AOM_ICDF(448), AOM_ICDF(32768), 0 }
      }
    },
  { // UV plane
    { // Inter
{AOM_ICDF(27072), AOM_ICDF(32768), 0 },
{AOM_ICDF(12352), AOM_ICDF(32768), 0 },
{AOM_ICDF(2880), AOM_ICDF(32768), 0 }
      },
    { // Inter
{AOM_ICDF(29888), AOM_ICDF(32768), 0 },
{AOM_ICDF(18752), AOM_ICDF(32768), 0 },
{AOM_ICDF(5568), AOM_ICDF(32768), 0 }
      }
    }
  };
static const blockz_cdf_model default_block_zero_cdf_32x32[PLANE_TYPES] = { 
  { // Y plane
    { // Intra
{AOM_ICDF(2240), AOM_ICDF(32768), 0 },
{AOM_ICDF(960), AOM_ICDF(32768), 0 },
{AOM_ICDF(192), AOM_ICDF(32768), 0 }
      },
    { // Intra
{AOM_ICDF(4672), AOM_ICDF(32768), 0 },
{AOM_ICDF(3776), AOM_ICDF(32768), 0 },
{AOM_ICDF(1344), AOM_ICDF(32768), 0 }
      }
    },
  { // UV plane
    { // Inter
{AOM_ICDF(23232), AOM_ICDF(32768), 0 },
{AOM_ICDF(7872), AOM_ICDF(32768), 0 },
{AOM_ICDF(1344), AOM_ICDF(32768), 0 }
      },
    { // Inter
{AOM_ICDF(25280), AOM_ICDF(32768), 0 },
{AOM_ICDF(10560), AOM_ICDF(32768), 0 },
{AOM_ICDF(3264), AOM_ICDF(32768), 0 }
      }
    }
  };
static const coeff_cdf_model default_coef_head_cdf_4x4[PLANE_TYPES] = {
  { // Y plane
    { // Intra
      { // Band 0
        {AOM_ICDF(3550), AOM_ICDF(9889), AOM_ICDF(20192), AOM_ICDF(22638), AOM_ICDF(32768)},
{AOM_ICDF(4942), AOM_ICDF(9404), AOM_ICDF(18957), AOM_ICDF(21171), AOM_ICDF(32768)},
{AOM_ICDF(5451), AOM_ICDF(7592), AOM_ICDF(16094), AOM_ICDF(17778), AOM_ICDF(32768)}
        },
      { // Band 1
...
{AOM_ICDF(1857), AOM_ICDF(2727), AOM_ICDF(5540), AOM_ICDF(8757), AOM_ICDF(32768)}
    ...
    { // Intra
      { // Band 0
        {AOM_ICDF(8577), AOM_ICDF(17662), AOM_ICDF(29438), AOM_ICDF(30220), AOM_ICDF(32768)},
{AOM_ICDF(11243), AOM_ICDF(18754), AOM_ICDF(29130), AOM_ICDF(29920), AOM_ICDF(32768)},
{AOM_ICDF(12763), AOM_ICDF(18706), AOM_ICDF(29035), AOM_ICDF(29729), AOM_ICDF(32768)}
        },
      { // Band 1
...
{AOM_ICDF(2113), AOM_ICDF(2183), AOM_ICDF(7202), AOM_ICDF(7377), AOM_ICDF(32768)}
  ...
  { // UV plane
    { // Inter
      { // Band 0
        {AOM_ICDF(4861), AOM_ICDF(23645), AOM_ICDF(30239), AOM_ICDF(31325), AOM_ICDF(32768)},
{AOM_ICDF(8803), AOM_ICDF(19798), AOM_ICDF(28148), AOM_ICDF(29497), AOM_ICDF(32768)},
{AOM_ICDF(9559), AOM_ICDF(15623), AOM_ICDF(25160), AOM_ICDF(26654), AOM_ICDF(32768)}
        },
      { // Band 1
...
{AOM_ICDF(2625), AOM_ICDF(2680), AOM_ICDF(8218), AOM_ICDF(8338), AOM_ICDF(32768)}
    ...
    { // Inter
      { // Band 0
        {AOM_ICDF(6975), AOM_ICDF(29416), AOM_ICDF(32749), AOM_ICDF(32759), AOM_ICDF(32768)},
{AOM_ICDF(10349), AOM_ICDF(26733), AOM_ICDF(32251), AOM_ICDF(32499), AOM_ICDF(32768)},
{AOM_ICDF(12895), AOM_ICDF(24442), AOM_ICDF(32028), AOM_ICDF(32275), AOM_ICDF(32768)}
        },
      { // Band 1
...
static const coeff_cdf_model default_coef_head_cdf_8x8[PLANE_TYPES] = { 
  { // Y plane
    { // Intra
      { // Band 0
        {AOM_ICDF(4047), AOM_ICDF(11945), AOM_ICDF(22020), AOM_ICDF(24409), AOM_ICDF(32768)},
{AOM_ICDF(4812), AOM_ICDF(8518), AOM_ICDF(17899), AOM_ICDF(20016), AOM_ICDF(32768)},
{AOM_ICDF(4554), AOM_ICDF(5219), AOM_ICDF(12121), AOM_ICDF(13031), AOM_ICDF(32768)}
        },
      { // Band 1
...
{AOM_ICDF(1473), AOM_ICDF(1486), AOM_ICDF(3735), AOM_ICDF(3820), AOM_ICDF(32768)}
    ...
    { // Intra
      { // Band 0
        {AOM_ICDF(8723), AOM_ICDF(16915), AOM_ICDF(29796), AOM_ICDF(30432), AOM_ICDF(32768)},
{AOM_ICDF(10339), AOM_ICDF(16422), AOM_ICDF(28344), AOM_ICDF(29109), AOM_ICDF(32768)},
{AOM_ICDF(11224), AOM_ICDF(14905), AOM_ICDF(26801), AOM_ICDF(27515), AOM_ICDF(32768)}
        },
      { // Band 1
...
{AOM_ICDF(2113), AOM_ICDF(2183), AOM_ICDF(7202), AOM_ICDF(7377), AOM_ICDF(32768)}
  ...
  { // UV plane
    { // Inter
      { // Band 0
        {AOM_ICDF(4596), AOM_ICDF(24652), AOM_ICDF(30861), AOM_ICDF(31732), AOM_ICDF(32768)},
{AOM_ICDF(8156), AOM_ICDF(18610), AOM_ICDF(27618), AOM_ICDF(29032), AOM_ICDF(32768)},
{AOM_ICDF(9044), AOM_ICDF(12347), AOM_ICDF(22570), AOM_ICDF(23823), AOM_ICDF(32768)}
        },
      { // Band 1
...
{AOM_ICDF(2625), AOM_ICDF(2680), AOM_ICDF(8218), AOM_ICDF(8338), AOM_ICDF(32768)}
    ...
    { // Inter
      { // Band 0
        {AOM_ICDF(9434), AOM_ICDF(29872), AOM_ICDF(32751), AOM_ICDF(32759), AOM_ICDF(32768)},
{AOM_ICDF(13950), AOM_ICDF(26796), AOM_ICDF(32582), AOM_ICDF(32697), AOM_ICDF(32768)},
{AOM_ICDF(17000), AOM_ICDF(23851), AOM_ICDF(32318), AOM_ICDF(32436), AOM_ICDF(32768)}
        },
      { // Band 1
...
static const coeff_cdf_model default_coef_head_cdf_16x16[PLANE_TYPES] = { 
  { // Y plane
    { // Intra
      { // Band 0
        {AOM_ICDF(4040), AOM_ICDF(8763), AOM_ICDF(17255), AOM_ICDF(20039), AOM_ICDF(32768)},
{AOM_ICDF(4040), AOM_ICDF(5986), AOM_ICDF(14106), AOM_ICDF(15917), AOM_ICDF(32768)},
{AOM_ICDF(3270), AOM_ICDF(3588), AOM_ICDF(8871), AOM_ICDF(9549), AOM_ICDF(32768)}
        },
      { // Band 1
...
{AOM_ICDF(2113), AOM_ICDF(2133), AOM_ICDF(5526), AOM_ICDF(5606), AOM_ICDF(32768)}
    ...
    { // Intra
      { // Band 0
        {AOM_ICDF(6734), AOM_ICDF(16003), AOM_ICDF(28605), AOM_ICDF(29502), AOM_ICDF(32768)},
{AOM_ICDF(7760), AOM_ICDF(13789), AOM_ICDF(26028), AOM_ICDF(27152), AOM_ICDF(32768)},
{AOM_ICDF(8914), AOM_ICDF(11597), AOM_ICDF(24005), AOM_ICDF(24790), AOM_ICDF(32768)}
        },
      { // Band 1
...
{AOM_ICDF(2113), AOM_ICDF(2183), AOM_ICDF(7202), AOM_ICDF(7377), AOM_ICDF(32768)}
  ...
  { // UV plane
    { // Inter
      { // Band 0
        {AOM_ICDF(4855), AOM_ICDF(23143), AOM_ICDF(30650), AOM_ICDF(31530), AOM_ICDF(32768)},
{AOM_ICDF(7126), AOM_ICDF(16313), AOM_ICDF(26484), AOM_ICDF(27999), AOM_ICDF(32768)},
{AOM_ICDF(6735), AOM_ICDF(9041), AOM_ICDF(19430), AOM_ICDF(20648), AOM_ICDF(32768)}
        },
      { // Band 1
...
{AOM_ICDF(6593), AOM_ICDF(6632), AOM_ICDF(13188), AOM_ICDF(13245), AOM_ICDF(32768)}
    ...
    { // Inter
      { // Band 0
        {AOM_ICDF(6872), AOM_ICDF(29719), AOM_ICDF(32745), AOM_ICDF(32756), AOM_ICDF(32768)},
{AOM_ICDF(10481), AOM_ICDF(25937), AOM_ICDF(31473), AOM_ICDF(32006), AOM_ICDF(32768)},
{AOM_ICDF(14690), AOM_ICDF(23457), AOM_ICDF(30895), AOM_ICDF(31423), AOM_ICDF(32768)}
        },
      { // Band 1
...
static const coeff_cdf_model default_coef_head_cdf_32x32[PLANE_TYPES] = { 
  { // Y plane
    { // Intra
      { // Band 0
        {AOM_ICDF(3399), AOM_ICDF(17242), AOM_ICDF(25074), AOM_ICDF(27553), AOM_ICDF(32768)},
{AOM_ICDF(3784), AOM_ICDF(7456), AOM_ICDF(15756), AOM_ICDF(18375), AOM_ICDF(32768)},
{AOM_ICDF(2886), AOM_ICDF(3385), AOM_ICDF(8559), AOM_ICDF(9626), AOM_ICDF(32768)}
        },
      { // Band 1
...
{AOM_ICDF(1857), AOM_ICDF(1875), AOM_ICDF(4936), AOM_ICDF(5018), AOM_ICDF(32768)}
    ...
    { // Intra
      { // Band 0
        {AOM_ICDF(2630), AOM_ICDF(21999), AOM_ICDF(29361), AOM_ICDF(30623), AOM_ICDF(32768)},
{AOM_ICDF(3400), AOM_ICDF(16162), AOM_ICDF(24964), AOM_ICDF(27296), AOM_ICDF(32768)},
{AOM_ICDF(4426), AOM_ICDF(11285), AOM_ICDF(20461), AOM_ICDF(23108), AOM_ICDF(32768)}
        },
      { // Band 1
...
{AOM_ICDF(2113), AOM_ICDF(2183), AOM_ICDF(7202), AOM_ICDF(7377), AOM_ICDF(32768)}
  ...
  { // UV plane
    { // Inter
      { // Band 0
        {AOM_ICDF(3673), AOM_ICDF(24050), AOM_ICDF(28692), AOM_ICDF(30441), AOM_ICDF(32768)},
{AOM_ICDF(4171), AOM_ICDF(19309), AOM_ICDF(25290), AOM_ICDF(28000), AOM_ICDF(32768)},
{AOM_ICDF(2758), AOM_ICDF(17499), AOM_ICDF(25023), AOM_ICDF(27609), AOM_ICDF(32768)}
        },
      { // Band 1
...
{AOM_ICDF(2625), AOM_ICDF(2680), AOM_ICDF(8218), AOM_ICDF(8338), AOM_ICDF(32768)}
    ...
    { // Inter
      { // Band 0
        {AOM_ICDF(1742), AOM_ICDF(31359), AOM_ICDF(32129), AOM_ICDF(32575), AOM_ICDF(32768)},
{AOM_ICDF(1862), AOM_ICDF(26739), AOM_ICDF(28564), AOM_ICDF(30566), AOM_ICDF(32768)},
{AOM_ICDF(2117), AOM_ICDF(20563), AOM_ICDF(23059), AOM_ICDF(27367), AOM_ICDF(32768)}
        },
      { // Band 1
...
#if CONFIG_COEFF_CTX_REDUCE
#if CONFIG_CHROMA_2X2
  av1_copy(fc->blockz_cdfs[TX_2X2], default_block_zero_cdf_4x4);
#endif  // CONFIG_CHROMA_2X2
  av1_copy(fc->blockz_cdfs[TX_4X4], default_block_zero_cdf_4x4);
  av1_copy(fc->blockz_cdfs[TX_8X8], default_block_zero_cdf_8x8);
  av1_copy(fc->blockz_cdfs[TX_16X16], default_block_zero_cdf_16x16);
  av1_copy(fc->blockz_cdfs[TX_32X32], default_block_zero_cdf_32x32);
#if CONFIG_TX64X64
  av1_copy(fc->blockz_cdfs[TX_64X64], default_block_zero_cdf_32x32);
#endif  // CONFIG_TX64X64
