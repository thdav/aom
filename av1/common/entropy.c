...
#if CONFIG_EC_ADAPT
static void av1_average_cdf(aom_cdf_prob* cdf_ptr[], aom_cdf_prob *fc_cdf_ptr, int cdf_size, const int num_tiles)
{
  int i, j;
...
void av1_average_tile_coef_cdfs(FRAME_CONTEXT *fc, FRAME_CONTEXT *ec_ctxs[], const int num_tiles) {
...
void av1_average_tile_intra_cdfs(FRAME_CONTEXT *fc, FRAME_CONTEXT *ec_ctxs[], const int num_tiles) {
...
void av1_average_tile_inter_cdfs(AV1_COMMON *cm, FRAME_CONTEXT *fc, FRAME_CONTEXT *ec_ctxs[], const int num_tiles) {
